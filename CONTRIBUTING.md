# Contributing to OpenEBS jiva-operator
...
* Find an issue to work on or create a new issue. 
  - The issues are maintained at [issues](https://github.com/openebs/jiva-operator/issues). 
  - You can pick up from a list of [good-first-issues](https://github.com/openebs/jiva-operator/labels/good%20first%20issue).
...
* Raise a new [Pull Request](https://github.com/openebs/jiva-operator/pulls).
