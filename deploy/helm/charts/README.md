...
| jivaOperator.image.tag | string | `"2.12.0"` |  Jiva operator image tag |
...
| jivaCSIPlugin.image.tag | string | `"2.12.0"` | Jiva CSI driver image tag |
...
| release.version | string | `"2.12.0"` | Openebs Jiva release version |
