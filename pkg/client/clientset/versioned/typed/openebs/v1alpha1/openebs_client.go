...
func (c *OpenebsV1alpha1Client) JivaVolumes(namespace string) JivaVolumeInterface {
	return newJivaVolumes(c, namespace)
}

func (c *OpenebsV1alpha1Client) JivaVolumePolicies(namespace string) JivaVolumePolicyInterface {
