...
type rolloutStatus func(*Statefulset) string
...
var rolloutStatuses = map[PredicateName]rolloutStatus{
	...
	PredicateProgressDeadlineExceeded: func(s *Statefulset) string {
	...
	PredicateOlderReplicaActive: func(s *Statefulset) string {
		if s.object.Spec.Replicas == nil {
